"""
Async Groq Cloud client wrapper for Wodi.
...
class GroqClient:
    ...
    async def vision_chat(
        ...
        try:
            ...
            log.warning("groq.vision_chat_fallback", error=str(e))
            text_msg = Message(role=ROLE_USER, content=prompt)
            return await self.chat(model=self.default_model, messages=[text_msg], temperature=temperature)
