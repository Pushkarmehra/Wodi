...
Stores past sessions/tasks with outcomes so Wodi can recall
...
class EpisodicMemory:
    ...
    Usage:
        mem = EpisodicMemory(db_path="~/.wodi/episodic.db")
        mem.open()
    ...
    def __init__(self, db_path: str | Path = "~/.wodi/episodic.db") -> None:
