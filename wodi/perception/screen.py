"""
Event-driven screen capture for Wodi.
    ...
    def start(self) -> None:
        ...
        if self._event_driven and self._try_win32_hook():
            ...
            self._thread = threading.Thread(
                target=self._poll_loop, daemon=True, name="wodi-screen-poll"
            )
            self._thread.start()
    ...
    def _try_win32_hook(self) -> bool:
        ...
        try:
            ...
            self._hook_thread = threading.Thread(
                target=self._message_pump, daemon=True, name="wodi-screen-hook"
            )
