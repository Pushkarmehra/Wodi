...
communicating via gRPC (defined in wodi.proto) for:
...
via Qt signals (see wodi/ui/app.py KernelSignalBridge).
"""
...
class IPCBridge:
    ...
    Phase 5: Replace Qt signal bridge in wodi/ui/app.py
