"""
Audit Log — Structured, persistent log of every Wodi action.
...
Viewable in the "Wodi Activity" panel in the UI.
"""
...
class AuditLog:
    ...
    Usage:
        audit = AuditLog(path="~/.wodi/audit.db")
        audit.open()
        audit.log_action(
            session_id="abc",
            tool_name="open_app",
