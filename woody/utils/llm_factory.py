"""
Woody LLM Factory — Multi-provider LangChain model factory.
...
Usage:
    from woody.utils.llm_factory import get_llm, get_provider_name
...
# Load .env from the workspace root (one level above the Woody package)
try:
